...
export default function BoxHero({
  ...
  return (
    <div
      className="w-full relative h-[350px] md:h-[560px] bg-cover md:bg-center bg-right"
    ...
    >
      <div className="container absolute md:top-1/2 bottom-[30px]  text-center md:text-start   transform md:-translate-y-1/2 md:w-[700px] text-black">
        ...
        <Button className="text-white bg-main-secondary mt-4 text-[16px] rounded-none w-full md:w-auto flex items-center gap-2">
